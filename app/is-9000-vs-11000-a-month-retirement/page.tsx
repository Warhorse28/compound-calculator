...
const metaTitle =
  "$9,000 vs $11,000 a Month in Retirement: What Changes?";

const pageTitle =
  "$9,000 vs $11,000 a Month in Retirement: What Changes?";

const pageDescription =
  "Compare retiring on $9,000 vs $11,000 a month. See how lifestyle, housing, healthcare, and long-term retirement flexibility can change across these two income levels.";
...
const comparisonRows = [
  {
    ...
    elevenK:
      "$11,000 a month usually supports an even more comfortable retirement lifestyle with greater margin, stronger resilience, and more day-to-day freedom.",
  },
  {
    category: "Housing flexibility",
    nineK:
      "Housing choices are already strong, but more expensive markets can still reduce flexibility or create tradeoffs over time.",
    elevenK:
      ...
      <article className={styles.article}>
        <header className={styles.hero}>
          ...
          <p className={styles.intro}>
            ...
            areas. But $11,000 a month usually creates more room for housing,
          ...
          <div className={styles.highlight}>
            <p className={styles.highlightText}>
              <strong>Key insight:</strong> $9,000 a month can support a strong
              retirement, while $11,000 a month usually creates a wider
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>
            When $9,000 a month can still be enough
          </h2>
          ...
          <p className={styles.paragraph}>
            In these conditions, $9,000 a month can support a comfortable and
            flexible retirement. But $11,000 a month still creates a wider
